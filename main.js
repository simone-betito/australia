async function drawTable() {
  ...
  function buildChart(d) {
    ...
    plumeGroup
      ...
      .attr('transform', d => `rotate(1) scale(${rScale(d.CoalExports)})`)
    ...
    d3.selectAll('#plume-group').attr('transform', function() {
      const plumeBounds = d3
        .select(this)
        .node()
        .getBoundingClientRect();

      return `translate(${dimensions.boundedWidth / 2 -
        plumeBounds.width / 2 +
        2}, ${dimensions.boundedHeight - plumeBounds.height - 145})`;
    });
