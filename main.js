async function drawTable() {
  ...
  function buildChart(d) {
    ...
    bounds
      ...
      .enter()
      .append('path')
      .attr('transform-origin', `${dimensions.boundedWidth / 2 - 5} 100%`)
      .style('fill', '#d9e3e3')
      .attr(
        'd',
      ...
      .attr('transform', function(d) {
        // const elementWidth = d3
        //   .select(this)
        //   .node()
        //   .getBoundingClientRect().width;
        return `translate(-2, -145) rotate(3) scale(${rScale(d.CoalExports)})`;
      });
  ...
  var mouseover = function([d]) {
    ...
    tooltip
      .html("<span style='color:grey'>Amount Exported in USD: </span>" + d.CoalExports)
